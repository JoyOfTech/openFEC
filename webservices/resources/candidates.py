...
class CandidateView(Resource):
    ...
    def get(self, **kwargs):
        ...
        count, candidates = self.get_candidates(args, page_num, per_page, **kwargs)
    ...
    def get_candidates(self, args, page_num, per_page, **kwargs):
        candidates = Candidate.query

        candidates = candidates.filter_by(**{'candidate_id': kwargs['id']})
